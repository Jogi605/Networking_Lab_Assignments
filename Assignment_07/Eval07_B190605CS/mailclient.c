  ...
  while(1){
          ...
          if(option == 3){
             break;
                ...
                printf(".......1.q-quit.......\n");
                printf(".......2.d-delete........\n");
                printf(".......3.Any character-show all mails and filter out.......\n");
                ...
                while(ch){
                       ...
                       if(ch == 'q'){
                          ...
                          scanf("%s%*c", email);
                          send_packet(pop3_sock, email, strlen(email));
                          int q = recieve_packet(pop3_sock, &m1);
                          //printf("%s\n", m1);
                          if(strcmp(m1, "INVALID EMAIL") == 0){
                                  printf("INVALID EMAIL --Enter the mail again:\n");
                                  scanf("%s%*c", email);
                                  send_packet(pop3_sock, email, strlen(email));
                                  int r = recieve_packet(pop3_sock, &m2);
                                  
                                  if(strcmp(m2, "INVALID EMAIL") == 0){
                                      printf("U have exhuasted your choices...\n");
                                      break;
                                  }
                                  else
                                     {
                                          ...
                                          if(strcmp(data, "NO MAILS TO SHOW") == 0){
